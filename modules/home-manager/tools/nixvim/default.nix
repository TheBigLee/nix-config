...
#      relativenumber = false; # don't show relative linenumbers
      ...
      listchars = "tab:»\ ,extends:›,precedes:‹,nbsp:·,trail:·"; # Display tabs and trailing spaces visually
      ...
      backup = false;
      # swap
      directory = "$HOME/.local/state/nvim/swap//,/tmp//";
      ...
      fileencoding = "utf8"; # UTF-8 by default
      fileformats = "unix,dos,mac";  # Prefer Unix
      formatoptions = "cqn1";
        # c - autowrap comments
      ...
      commentstring = "\ \ #%s"; # When folds are created, add them to this
      fillchars = "stl:\ ,stlnc:\ ,fold:-,diff:┄"; #  Unicode chars for diffs/folds, and rely on Colors for window borders
      ...
      infercase = true; # Completion recognizes capitalization
