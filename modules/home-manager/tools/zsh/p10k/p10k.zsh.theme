# Generated by Powerlevel10k configuration wizard on 2021-03-25 at 13:55 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*(lab|kind|test)*'  TEST    # to match your needs. Customize them as needed.
      '*(appuio|prod)*'  APPUIO    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_BACKGROUND=2
  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_CONTENT_EXPANSION='${P9K_KUBECONTEXT_CLUSTER}'
  POWERLEVEL9K_KUBECONTEXT_TEST_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'

  typeset -g POWERLEVEL9K_KUBECONTEXT_APPUIO_FOREGROUND=7
  typeset -g POWERLEVEL9K_KUBECONTEXT_APPUIO_BACKGROUND=1
  typeset -g POWERLEVEL9K_KUBECONTEXT_APPUIO_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_KUBECONTEXT_APPUIO_CONTENT_EXPANSION='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_CLUSTER}}'
  POWERLEVEL9K_KUBECONTEXT_APPUIO_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
